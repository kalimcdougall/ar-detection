...
uflux = funcs.readNC('path/to/file/e-ivt.nc', 'p71.162')
vflux = funcs.readNC('path/to/file/n-ivt.nc', 'p72.162')

#======================================================
# Create ivt output file
dir = 'path/to/directory/'

output_file = dir + 'ivt.nc' # Create output file for ivt calculation
#======================================================
# Compute & plot IVT
...
abpath_out = os.path.join(dir, 'ar_records.csv')
print('\n# Saving output to :\n', abpath_out)
...
print('\n# Read in file:\n', 'ar_records.csv')
ardf = readCSVRecord(dir + 'ar_records.csv')
...
abpath_out = os.path.join(dir,'ar_tracks.csv')
print('\n# Saving output to:\n',abpath_out)
if sys.version_info.major==2:
    np.set_printoptions(threshold=np.inf)
elif sys.version_info.major==3:
